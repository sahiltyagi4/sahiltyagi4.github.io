...
> Hello! I'm a postdoc in the [Analytics and AI Methods at Scale (AAIMS)](https://www.ornl.gov/group/aaims) group at [Oak Ridge National Laboratory (ORNL)](https://www.ornl.gov/). My current work encompasses scalable ML/AI and federated learning. I'm also involved in the DoE-directed (US Department of Energy) _Genesis Mission_ effort [[link1](https://genesis.energy.gov/), [link2](https://www.whitehouse.gov/presidential-actions/2025/11/launching-the-genesis-mission/)].
...
> Happy to connect and collaborate. I can be reached at [[email]](mailto:tyagis@ornl.gov).
...
- **09/2026** - Organized the 3rd Workshop on ([Federated and Privacy-Preserving AI for HPC (FPAI-HPC’26)](https://hpcfl.github.io/Cluster26/)) in conjunction with [IEEE CLUSTER'26](https://clustercomp.org/2026/) on September 22, 2026 in Alexandria, VA.

- **06/2026** - Attended 2026 Trillion Parameter Consortium ([TPC26](https://tpc26.org/)) in Baltimore, MD, and showcased my work on cross-facility federated learning [[link]](https://www.linkedin.com/posts/share-7467908723143757824-XKcJ/?utm_source=share&utm_medium=member_desktop&rcm=ACoAAAl445kBd7ZWXOPv2bu_TLj8ZOqaQ2ci_mY).
...
- **12/2025** - Serving on the TPC at the 2026 International Conference for High Performance Computing, Networking, Storage and Analysis, under Data Analytics, Visualization and Storage track ([SC'26](https://sc26.supercomputing.org/community-engagement/planning-committee/)).
...
> - **Conference proceedings**
	...
	> 1. Chaturvedi, S., **Tyagi, S.**, & Simmhan, Y. Collaborative Reuse of Streaming Dataflows in IoT Applications. 2017 IEEE 13th International Conference on e-Science (**e-Science '17**), 403-412 *(Accpt. rate 36%)* [[pdf]](files/collaborative_escience.pdf).<br/>
